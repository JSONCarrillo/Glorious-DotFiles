...
-- Theme
beautiful.init("/home/bigboss/.config/awesome/theme.lua")
...
-- Modkey Mod4 being the Windows/Super key
modkey = "Mod4"
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "Main", "Gaming", ">_", "Media", "Misc." }, s, awful.layout.layouts[1])
